...
public class BeginKeratosisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<BeginKeratosis> arrayList = new ArrayList<BeginKeratosis>();
      ...
      //  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        //---------------Melanoma-------------
        arrayList.add(new BeginKeratosis( "", "Melanoma is not the most common type of skin \n" +
    ...
    BeginKeratosisView melanomaView = new BeginKeratosisView(this , arrayList);
