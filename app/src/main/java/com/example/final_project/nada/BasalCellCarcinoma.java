...
public class BasalCellCarcinoma {
    private int Img ;
    ...
    public BasalCellCarcinoma(String mainTitle, int img, String describtion_Title ) {
    ...
    public BasalCellCarcinoma(String mainTitle, String describtion_Title) {
        this.mainTitle = mainTitle;
        this.describtion_Title = describtion_Title;
    }
