...
public class Dermatofibroma {
    ...
    public Dermatofibroma(String mainTitle, int img, String describtion_Title ) {
    ...
    public Dermatofibroma(String mainTitle, String describtion_Title) {
        this.mainTitle = mainTitle;
        this.describtion_Title = describtion_Title;
    }
