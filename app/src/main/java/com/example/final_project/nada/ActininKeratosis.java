...
public class ActininKeratosis {
    ...
    public ActininKeratosis(String mainTitle, int img, String describtion_Title ) {
    ...
    public ActininKeratosis(String mainTitle, String describtion_Title) {
        this.mainTitle = mainTitle;
        this.describtion_Title = describtion_Title;
    }
