...
public class DermatofibromaView extends ArrayAdapter<Dermatofibroma> {

    public DermatofibromaView(@NonNull Context context , ArrayList<Dermatofibroma> dermatofibromas) {
        super(context, 0, dermatofibromas);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Dermatofibroma currentNumberPosition = getItem(position);
