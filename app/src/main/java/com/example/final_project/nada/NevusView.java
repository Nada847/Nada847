...
public class NevusView extends ArrayAdapter<com.example.final_project.nada.Nevus> {


    public NevusView(@NonNull Context context, ArrayList<com.example.final_project.nada.Nevus> arrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        com.example.final_project.nada.Nevus currentNumberPosition = getItem(position);
