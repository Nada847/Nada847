...
public class VascularLesion {
    ...
    public VascularLesion(String mainTitle, int img, String describtion_Title ) {
    ...
    public VascularLesion(String mainTitle, String describtion_Title) {
        this.mainTitle = mainTitle;
        this.describtion_Title = describtion_Title;
    }
