...
public class BeginKeratosis {
    ...
    public BeginKeratosis(String mainTitle, int img, String describtion_Title ) {
    ...
    public BeginKeratosis(String mainTitle, String describtion_Title) {
        this.mainTitle = mainTitle;
        this.describtion_Title = describtion_Title;
    }
