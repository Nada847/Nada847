...
public class MelanomaView extends ArrayAdapter<Melanoma> {

    public MelanomaView(@NonNull Context context, ArrayList<Melanoma> beginKeratosis) {
        super(context, 0, beginKeratosis);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Melanoma currentNumberPosition = getItem(position);
