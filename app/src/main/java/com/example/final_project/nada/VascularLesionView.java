...
public class VascularLesionView extends ArrayAdapter<com.example.final_project.nada.VascularLesion> {

    public VascularLesionView(@NonNull Context context, ArrayList<com.example.final_project.nada.VascularLesion> vascularLesions) {
        super(context, 0, vascularLesions);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        com.example.final_project.nada.VascularLesion currentNumberPosition = getItem(position);
