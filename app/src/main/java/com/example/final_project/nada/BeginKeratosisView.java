...
public class BeginKeratosisView extends ArrayAdapter<BeginKeratosis> {

    public BeginKeratosisView( @NonNull Context context , ArrayList<BeginKeratosis> beginKeratoses) {
        super(context, 0, beginKeratoses);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        BeginKeratosis currentNumberPosition = getItem(position);
