...
public class BasalCellCarcinomaView extends ArrayAdapter<BasalCellCarcinoma> {

    public BasalCellCarcinomaView(@NonNull Context context , ArrayList<BasalCellCarcinoma> basalCellCarcinomas) {
        super(context, 0, basalCellCarcinomas);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        BasalCellCarcinoma currentNumberPosition = getItem(position);
