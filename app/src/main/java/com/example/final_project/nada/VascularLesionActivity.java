...
public class VascularLesionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<VascularLesion> arrayList = new ArrayList<VascularLesion>();
      ...
      //  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        //---------------Melanoma-------------
        arrayList.add(new VascularLesion( "", "Melanoma is not the most common type of skin \n" +
    ...
    VascularLesionView melanomaView = new VascularLesionView(this , arrayList);
