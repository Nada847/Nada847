...
public class Basal_Details_Activity extends AppCompatActivity {
    CardView cardcaues  , cardsymptoms  , cardtreatment , cardprevention;
    Toolbar toolbar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_basal_details);

        toolbar = findViewById(R.id.Basaltoolbar);
        ...
        cardcaues.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext() , Basal_causes_Activity.class);
        ...
        cardsymptoms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext() , Basal_Symptoms_Activity.class);
                startActivity(intent);
        ...
        cardtreatment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext() , Basal_Treatment_Activity.class);
                startActivity(intent);
        ...
        cardprevention.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext() , Basal_Prevention_Activity.class);
                startActivity(intent);
