...
import com.example.final_project.databinding.ActivityPatientRegisterBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.genderEt.setOnClickListener(new View.OnClickListener() {
            ...
            private void showOptionDaialog() {
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(PatientRegister.this);
        ...
        ref.child(uid)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        progressDialog.dismiss();
                        Toast.makeText(PatientRegister.this,"Account created...",Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(PatientRegister.this, MainActivity.class));
                        finish();
